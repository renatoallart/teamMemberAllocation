...
export function GroupTeamMembers({ employees, selectedTeam, setSelectedTeam }) { 
    ...
    function handleTeamClick(team) {
      setGroupedData(oldStatsEmployee => oldStatsEmployee.map(groupedData => groupedData.team === team
